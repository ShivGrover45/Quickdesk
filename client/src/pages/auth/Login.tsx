    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:flex-1 bg-gradient-brand items-center justify-center p-12">
        <div className="text-center text-white">
          ...
          <h2 className="text-3xl font-bold mb-4">Welcome to QuickDesk</h2>
          <p className="text-xl text-white/90 mb-8">
            Streamline your support operations with our comprehensive help desk solution
          </p>
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="border-0 shadow-lg">
            <CardHeader className="space-y-1 text-center">
              ...
              <CardDescription>
                Enter your email and password to access your QuickDesk dashboard
              </CardDescription>
            </CardHeader>
